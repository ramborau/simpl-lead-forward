...
export async function POST(request: Request) {
  try {
    ...
    facebookAuthUrl.searchParams.append('redirect_uri', `${process.env.NEXTAUTH_URL}/api/facebook/callback`)
    facebookAuthUrl.searchParams.append('scope', 'pages_manage_metadata,pages_read_engagement,leads_retrieval')
